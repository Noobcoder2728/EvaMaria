...
async def who_is(client, message):
    ...
    message_out_str += f"<b>➥ʟᴀsᴛ ɴᴀᴍᴇ:</b> {last_name}\n"
    ...
    message_out_str += f"<b>➲ᴜsᴇʀ ʟɪɴᴋ:</b> @{username}\n"
    message_out_str += f"<b>➲ᴜsᴇʀ ʟɪɴᴋ:</b> <a href='tg://user?id={from_user.id}'><b>Click Here</b></a>\n"
